...
export default {
  ...
  "st.display.help_improve.desc_html": "Permite conservar determinadas interacciones de WebBrain Cloud y utilizarlas para evaluación, mejora, ajuste fino y entrenamiento. Activado de forma predeterminada. Desactívalo para impedir que futuras interacciones de Cloud se utilicen con esos fines. WebBrain nunca recopila solicitudes de modelos locales ni solicitudes enviadas con tus propias credenciales de API. <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Política de privacidad →</a>",
  "st.providers.webbrain_data_use.body": "Se incluye uso diario gratuito de WebBrain Cloud. Mientras Ayuda a mejorar WebBrain está activado de forma predeterminada, algunas conversaciones de Cloud pueden conservarse y utilizarse para evaluación, mejora, ajuste fino y entrenamiento. Desactívalo en General → Avanzado para excluir futuras interacciones de Cloud de esos usos. WebBrain nunca recopila solicitudes de modelos locales ni solicitudes enviadas con tus propias credenciales de API. {privacyLink}. Para obtener más uso, suscríbete en {subscribeLink}. Gestiona la facturación en {accountLink}.",
