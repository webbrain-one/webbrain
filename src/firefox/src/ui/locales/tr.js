...
export default {
  ...
  "st.display.help_improve.desc_html": "Seçili WebBrain Cloud etkileşimlerinin saklanmasına ve değerlendirme, iyileştirme, ince ayar ve eğitim için kullanılmasına izin verin. Varsayılan olarak açıktır. Gelecekteki Cloud etkileşimlerinin bu amaçlarla kullanılmasını önlemek için kapatın. Yerel model istekleri ve kendi API kimlik bilgilerinizle gönderilen istekler WebBrain tarafından hiçbir zaman toplanmaz. <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Gizlilik politikası →</a>",
  "st.providers.webbrain_data_use.body": "Ücretsiz günlük WebBrain Cloud kullanımı dahildir. WebBrain’i İyileştirmeye Yardım Et varsayılan olarak açıkken, seçili Cloud konuşmaları değerlendirme, iyileştirme, ince ayar ve eğitim için saklanabilir ve kullanılabilir. Gelecekteki Cloud etkileşimlerini bu kullanımların dışında tutmak için Genel → Gelişmiş bölümünden kapatın. Yerel model istekleri ve kendi API kimlik bilgilerinizle gönderilen istekler WebBrain tarafından hiçbir zaman toplanmaz. {privacyLink}. Daha fazla kullanım için {subscribeLink} adresinden abone olun. Faturalandırmayı {accountLink} adresinden yönetin.",
