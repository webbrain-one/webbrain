...
export default {
  ...
  "sp.memory.remember_empty": "/remember の後に記憶する内容を入力してください。",
  "sp.memory.remembered": "ユーザーメモリに保存しました。",
  "sp.memory.forget_empty": "/forget-memory の後にメモリ ID を貼り付けてください。",
  ...
  "st.memory.desc_html": "回答スタイル、繰り返し使うワークフロー設定、長期的なプロフィール情報、現在のタスク以降にも適用する確認回答など、WebBrain に記憶させる安定した設定を保存します。<code>/remember</code> を明示的に使うとすぐに保存されます。自動学習は任意で、ターンの完了後にのみ実行されます。",
