...
export default {
  ...
  'st.skills.source.built_in': '内置默认',
  ...
  'sp.scratchpad.edit_empty': '在 /edit-scratchpad 后添加文本以将其追加到暂存器。',
  'sp.plan.title': '审查计划',
  ...
  "sp.memory.remember_empty": "请在 /remember 后输入要记住的内容。",
  "sp.memory.remembered": "已保存到用户记忆。",
  "sp.memory.forget_empty": "请在 /forget-memory 后粘贴记忆 ID。",
  ...
  "st.memory.desc_html": "保存 WebBrain 应记住的稳定偏好，例如回答风格、重复使用的工作流选择、长期个人资料提示，或应在当前任务之外继续适用的澄清答案。显式使用 <code>/remember</code> 会立即保存；自动学习为可选功能，仅在一轮对话完成后运行。",
