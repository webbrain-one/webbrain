...
export default {
  ...
  "st.system_one.desc_html": "Vérification supplémentaire des surveillances et tâches planifiées.",
  "st.system_one.enabled.label": "Activer Jev",
  "st.system_one.api_key.label": "Clé API TypeSafe",
  "st.system_one.watch.label": "Vérifier les surveillances planifiées",
  "st.system_one.completion.label": "Vérifier la fin des tâches planifiées",
  "st.system_one.security_html": "Envoie la tâche et des éléments limités de la page à TypeSafe. La clé est stockée localement en clair. L’utilisation peut être payante. Strict Secret Mode désactive Jev.",
  ...
  'install.showcase.ask.title': "Interrogez n’importe quelle page. Gardez l’essentiel.",
  'install.showcase.ask.body': "Des réponses nettes à partir de pages brouillonnes. Lecture seule par défaut.",
  'install.showcase.act.title': "Dites au navigateur quoi faire.",
  'install.showcase.model.title': "Utilisez le modèle auquel vous faites confiance.",
  'install.showcase.model.body': "Local, cloud, ou vos propres clés — changez à tout moment.",
  'install.showcase.apocalypse.body': "Des connaissances hors ligne, sous votre contrôle. Téléchargez l’essentiel tant que vous le pouvez.",
  ...
  "sp.btn.clear_short": "Nouvelle conversation",
  "sp.btn.history_short": "Historique",
  ...
  'tool.set_checked': "Mise à jour de la case à cocher",
  'tool.hover': "Survol",
  'tool.drag_drop': "Glisser-déposer de l'élément",
  'tool.press_keys': "Pression de touches",
  'tool.press_keys.keys': "Pression de {keys}",
  'tool.find_text': "Recherche de texte",
  'tool.find_text.text': "Recherche de «{text}»",
  'tool.upload_file': "Téléversement de fichier",
  'tool.download_files': "Téléchargement de fichiers",
  'tool.download_media': "Téléchargement de média",
  'tool.download_resource': 'Téléchargement du fichier',
  'tool.check_downloads': "Vérification des téléchargements",
  'tool.read_downloaded_file': "Lecture du fichier téléchargé",
  'tool.read_frame': "Lecture du cadre",
  'tool.get_frames': 'Liste des cadres',
  'tool.solve_captcha': "Résolution de la vérification",
  'tool.clarify': "Demande de clarification",
  'tool.get_window_info': "Vérification de la fenêtre",
  'tool.resize_window': "Redimensionnement de la fenêtre",
  'tool.inspect_viewport': "Inspection de la fenêtre d'affichage",
  'tool.scratchpad_write': "Mise à jour des notes",
  'tool.progress_update': "Mise à jour de la progression",
  'tool.progress_read': "Lecture de la progression",
  'tool.verify_form': "Vérification du formulaire",
  'tool.chat_observe': "Observation du chat",
  ...
  'tool.staged_screenshot': 'Description de la capture',
  ...
  'st.provider.field.api_format': 'Format de l\'API',
  ...
  "st.vision.local.testing": "Chargement et test du modèle de vision local…",
  ...
  "st.tab.multimodal": "Modèles auxiliaires",
  ...
  "st.transcription.heading": "Parole en texte",
  ...
  'st.display.cloud_bridge.desc': 'Connectez un contrôleur local à ce profil Chromium via le port 17374. Un seul pont peut être actif à la fois et les demandes d’autorisation standard restent applicables.',
  ...
  'st.display.always_allow_api_mutations.desc': "Autoriser WebBrain à utiliser POST, PUT, PATCH et DELETE via fetch_url ou research_url sans exiger /allow-api dans chaque conversation. Les directives UI-d’abord et les confirmations restent applicables. Activé par défaut.",
  'st.display.api_mutation_observer.label': 'Observateur de mutations API',
  'st.display.api_mutation_observer.desc': 'Observer les URLs et méthodes des requêtes XHR/fetch dans le même onglet pour que WebBrain puisse détecter des actions UI répétées et suggérer des modèles de raccourcis API. Activé par défaut.',
  ...
  "st.display.webmcp.desc": "Autorise WebBrain à découvrir et exécuter les outils structurés proposés par les pages Chrome compatibles. Son activation ajoute les outils WebMCP expérimentaux et leurs instructions au contexte du modèle. Activé par défaut.",
  ...
  "st.display.help_improve.desc_html": "Autorise la conservation de certaines interactions WebBrain Compass et leur utilisation pour l’évaluation, l’amélioration, l’ajustement fin et l’entraînement. Activé par défaut. Désactivez cette option pour empêcher que les futures interactions Compass soient utilisées à ces fins. <u>Les requêtes des modèles locaux et de vos propres API ne sont collectées par WebBrain que pour les fournisseurs où vous activez « Partager les requêtes pour la recherche ».</u> <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Politique de confidentialité →</a>",
  "st.providers.webbrain_data_use.body": "Une utilisation quotidienne gratuite de WebBrain Compass est incluse. Tant que Aider à améliorer WebBrain est activé par défaut, certaines conversations Compass peuvent être conservées et utilisées pour l’évaluation, l’amélioration, l’ajustement fin et l’entraînement. Désactivez cette option dans Général → Avancé pour exclure les futures interactions Compass de ces usages. <u>Les requêtes des modèles locaux et de vos propres API ne sont collectées par WebBrain que si vous activez l’option « Partager les requêtes pour la recherche » de ce fournisseur.</u> {privacyLink}. Pour davantage d’utilisation, abonnez-vous sur {subscribeLink}. Gérez la facturation sur {accountLink}.",
  'st.providers.share_research.label': "Partager les requêtes pour la recherche",
  'st.providers.share_research.hint': "Envoie les prompts et les réponses de ce fournisseur à WebBrain pour évaluation et amélioration, y compris le fournisseur et le modèle utilisés. Les images et pièces jointes binaires sont supprimées et le texte est tronqué avant partage ; le texte restant est envoyé tel quel.",
  'st.providers.share_research.confirm': "Partager les requêtes de ce fournisseur avec WebBrain pour la recherche ?\n\nSi activé, vos prompts, réponses et interactions d’outils avec ce fournisseur seront envoyés à WebBrain pour évaluation et amélioration, avec le nom du fournisseur et du modèle. Le texte est envoyé tel quel après suppression des images et troncation des contenus longs : évitez donc de partager des données personnelles sensibles. Vous pouvez désactiver cette option à tout moment pour arrêter le partage.",
  ...
  "st.sync.status.subscription": "L'adhésion à WebBrain Compass est requise pour la synchronisation cryptée.",
  "st.sync.status.error": "La synchronisation cryptée nécessite votre attention.",
  "st.sync.status.auth_required": "Connectez-vous avec votre adresse e-mail WebBrain Compass pour utiliser la synchronisation cryptée.",
  ...
  "st.sync.validation.email_required": "Saisissez votre e-mail de facturation WebBrain Compass.",
  ...
  "st.sync.auth.check_email": "Vérifiez votre courrier électronique, approuvez le lien de connexion WebBrain Compass, puis revenez ici.",
