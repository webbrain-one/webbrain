...
export default {
  ...
  'st.skills.source.built_in': 'Intégré par défaut',
  ...
  "sp.memory.remember_empty": "Saisissez ce qu’il faut mémoriser après /remember.",
  "sp.memory.remembered": "Enregistré dans la mémoire utilisateur.",
  "sp.memory.forget_empty": "Collez un identifiant de mémoire après /forget-memory.",
