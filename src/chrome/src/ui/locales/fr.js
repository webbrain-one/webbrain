...
export default {
  ...
  "st.display.help_improve.desc_html": "Autorise la conservation de certaines interactions WebBrain Cloud et leur utilisation pour l’évaluation, l’amélioration, l’ajustement fin et l’entraînement. Activé par défaut. Désactivez cette option pour empêcher que les futures interactions Cloud soient utilisées à ces fins. WebBrain ne collecte jamais les requêtes de modèles locaux ni celles envoyées avec vos propres identifiants d’API. <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Politique de confidentialité →</a>",
  "st.providers.webbrain_data_use.body": "Une utilisation quotidienne gratuite de WebBrain Cloud est incluse. Tant que Aider à améliorer WebBrain est activé par défaut, certaines conversations Cloud peuvent être conservées et utilisées pour l’évaluation, l’amélioration, l’ajustement fin et l’entraînement. Désactivez cette option dans Général → Avancé pour exclure les futures interactions Cloud de ces usages. WebBrain ne collecte jamais les requêtes de modèles locaux ni celles envoyées avec vos propres identifiants d’API. {privacyLink}. Pour davantage d’utilisation, abonnez-vous sur {subscribeLink}. Gérez la facturation sur {accountLink}.",
