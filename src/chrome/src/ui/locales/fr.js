...
export default {
  ...
  'sp.slash.busy_only_oob': 'Les messages sont mis en file d\'attente pendant que WebBrain est occupé. Seuls /help, /check-progress, /show-scratchpad, /list-schedules, /dangerously-skip-permissions, /screenshot, /export et /verbose peuvent s\'exécuter immédiatement comme commandes slash.',
  ...
  'st.display.plan_before_act.desc': 'En mode Act, générer optionnellement un plan structuré avant l\'exécution des outils. Désactivé par défaut. Le mode Essai continue sans plan fixe si la planification échoue ; le mode Strict annule à la place. Ajoute un appel LLM par tour Act quand activé.',
  'st.display.plan_before_act.try': 'Essayer la planification',
  'st.display.plan_before_act.strict': 'Planification stricte',
  'st.display.plan_before_act.off': 'Désactivé (par défaut)',
