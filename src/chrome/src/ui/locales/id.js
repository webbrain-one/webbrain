...
export default {
  ...
  'st.display.plan_before_act.desc': 'Dalam mode Bertindak, secara opsional buat rencana terstruktur sebelum alat dijalankan. Mode Coba adalah default: mode ini lanjut tanpa rencana tetap jika perencanaan gagal; mode Ketat membatalkan sebagai gantinya. Menambahkan satu panggilan LLM per giliran Bertindak saat perencanaan aktif.',
