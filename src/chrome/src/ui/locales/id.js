...
export default {
  ...
  'sp.ui_scale.reset': 'Atur ulang',
  'st.display.ui_scale.label': 'Zoom UI ekstensi',
  'st.display.ui_scale.decrease': 'Perkecil UI ekstensi',
  'st.display.ui_scale.increase': 'Perbesar UI ekstensi',
  'st.display.ui_scale.reset': 'Atur ulang',
  'st.display.ui_scale.desc': 'Ubah ukuran panel samping dan jendela chat terpisah tanpa mengubah zoom halaman.',
  'st.display.ui_scale.shortcuts': 'Pintasan khusus: {shortcuts}',
  'st.display.ui_scale.shortcuts_none': 'Belum ditetapkan',
  ...
  "st.system_one.desc_html": "Verifikasi tambahan untuk pemantauan terjadwal dan penyelesaian tugas.",
  "st.system_one.enabled.label": "Aktifkan Jev",
  "st.system_one.api_key.label": "Kunci API TypeSafe",
  "st.system_one.watch.label": "Verifikasi pemantauan terjadwal",
  "st.system_one.completion.label": "Verifikasi penyelesaian tugas terjadwal",
  "st.system_one.security_html": "Mengirim tugas dan bukti halaman terbatas ke TypeSafe. Kunci disimpan lokal sebagai teks biasa dan penggunaan dapat dikenai biaya. Strict Secret Mode menonaktifkan Jev.",
  ...
  "sp.btn.clear_short": "Percakapan baru",
  "sp.btn.history_short": "Riwayat",
  ...
  'tool.set_checked': "Memperbarui kotak centang",
  'tool.hover': "Mengarahkan kursor",
  'tool.drag_drop': "Menyeret elemen",
  'tool.press_keys': "Menekan tombol",
  'tool.press_keys.keys': "Menekan {keys}",
  'tool.find_text': "Mencari teks",
  'tool.find_text.text': "Mencari \"{text}\"",
  'tool.upload_file': "Mengunggah file",
  'tool.download_files': "Mengunduh file",
  'tool.download_media': "Mengunduh media",
  'tool.download_resource': 'Mengunduh file',
  'tool.check_downloads': "Memeriksa unduhan",
  'tool.read_downloaded_file': "Membaca file terunduh",
  'tool.read_frame': "Membaca bingkai",
  'tool.get_frames': 'Mencantumkan bingkai',
  'tool.solve_captcha': "Menyelesaikan verifikasi",
  'tool.clarify': "Meminta klarifikasi",
  'tool.get_window_info': "Memeriksa jendela",
  'tool.resize_window': "Mengubah ukuran jendela",
  'tool.inspect_viewport': "Memeriksa area tampilan",
  'tool.scratchpad_write': "Memperbarui catatan",
  'tool.progress_update': "Memperbarui progres",
  'tool.progress_read': "Membaca progres",
  'tool.verify_form': "Memverifikasi formulir",
  'tool.chat_observe': "Mengamati obrolan",
  'tool.chat_send': "Mengirim pesan",
  'tool.load_skill': "Memuat keterampilan",
  'tool.execute_webmcp_tool': "Menjalankan alat WebMCP",
  'tool.list_webmcp_tools': 'Mencantumkan alat WebMCP',
  'tool.beep': "Memutar suara peringatan",
  ...
  'tool.staged_screenshot': 'Mendeskripsikan tangkapan layar',
  ...
  "st.vision.local.testing": "Memuat dan menguji visi lokal…",
  ...
  "st.tab.multimodal": "Model Pendukung",
  ...
  "st.transcription.heading": "Ucapan ke teks",
  ...
  'st.display.cloud_bridge.desc': 'Hubungkan satu pengontrol lokal ke profil Chromium ini melalui port 17374. Hanya satu bridge yang dapat aktif pada satu waktu, dan permintaan izin standar tetap berlaku.',
  ...
  "sp.attach.unsupported_type": "{name} bukan tipe lampiran yang didukung — hanya gambar, PDF, JSON, TXT, CSV, dan Markdown yang didukung.",
  ...
  "st.sync.lede_html": "<strong>Khusus anggota WebBrain Compass.</strong> Menyinkronkan memori, pengisian otomatis profil, dan pengaturan penyedia kunci API di seluruh perangkat. Semuanya dienkripsi dengan kata sandi sinkronisasi Anda sebelum diunggah. WebBrain tidak dapat membaca atau memulihkannya. Riwayat obrolan dan proses masuk OAuth tidak disinkronkan.",
  ...
  "st.sync.status.subscription": "Keanggotaan WebBrain Compass diperlukan untuk sinkronisasi terenkripsi.",
  "st.sync.status.error": "Sinkronisasi terenkripsi memerlukan perhatian.",
  "st.sync.status.auth_required": "Masuk dengan email WebBrain Compass Anda untuk menggunakan sinkronisasi terenkripsi.",
  ...
  "st.sync.validation.email_required": "Masukkan email penagihan WebBrain Compass Anda.",
  ...
  "st.sync.auth.check_email": "Periksa email Anda, setujui tautan masuk WebBrain Compass, lalu kembali ke sini.",
