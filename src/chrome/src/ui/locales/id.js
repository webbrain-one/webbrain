...
export default {
  ...
  'st.skills.source.built_in': 'Bawaan default',
  ...
  'sp.scratchpad.edit_empty': 'Tambahkan teks setelah /edit-scratchpad untuk menambahkannya ke scratchpad.',
  ...
  "sp.memory.remember_empty": "Ketik hal yang perlu diingat setelah /remember.",
  "sp.memory.remembered": "Disimpan ke memori pengguna.",
  "sp.memory.forget_empty": "Tempelkan ID memori setelah /forget-memory.",
  ...
  "st.memory.desc_html": "Simpan preferensi stabil yang perlu diingat WebBrain, seperti gaya jawaban, pilihan alur kerja berulang, petunjuk profil yang bertahan lama, atau jawaban klarifikasi yang perlu berlaku setelah tugas saat ini. <code>/remember</code> menyimpan secara langsung; pembelajaran otomatis bersifat opsional dan hanya berjalan setelah satu giliran selesai.",
