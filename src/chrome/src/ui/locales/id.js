...
export default {
  ...
  'sp.slash.busy_only_oob': 'Pesan dimasukkan ke antrean saat WebBrain sibuk. Hanya /help, /check-progress, /show-scratchpad, /list-schedules, /dangerously-skip-permissions, /screenshot, /export, dan /verbose yang dapat langsung berjalan sebagai perintah slash.',
  ...
  'st.display.plan_before_act.desc': 'Dalam mode Bertindak, secara opsional buat rencana terstruktur sebelum alat dijalankan. Nonaktif secara default. Mode Coba lanjut tanpa rencana tetap jika perencanaan gagal; mode Ketat membatalkan sebagai gantinya. Menambahkan satu panggilan LLM per giliran Bertindak saat diaktifkan.',
  'st.display.plan_before_act.try': 'Coba rencanakan',
  'st.display.plan_before_act.strict': 'Perencanaan ketat',
  'st.display.plan_before_act.off': 'Nonaktif (default)',
