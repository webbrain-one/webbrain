...
export default {
  ...
  'sp.scratchpad.edit_empty': 'أضف نصاً بعد /edit-scratchpad لإضافته إلى المسودة.',
  ...
  "sp.memory.remember_empty": "اكتب ما تريد تذكّره بعد /remember.",
  "sp.memory.remembered": "تم الحفظ في ذاكرة المستخدم.",
  "sp.memory.forget_empty": "الصق معرّف ذاكرة بعد /forget-memory.",
  ...
  "st.memory.desc_html": "احفظ التفضيلات الثابتة التي ينبغي لـ WebBrain تذكّرها، مثل أسلوب الإجابة وخيارات سير العمل المتكررة وتلميحات الملف الشخصي الدائمة أو إجابات التوضيح التي ينبغي تطبيقها بعد المهمة الحالية. يحفظ <code>/remember</code> مباشرةً؛ والتعلّم التلقائي اختياري ولا يعمل إلا بعد اكتمال الجولة.",
