...
export default {
  ...
  "st.system_one.desc_html": "تحقق إضافي من المراقبة المجدولة وإتمام المهام.",
  "st.system_one.enabled.label": "تفعيل Jev",
  "st.system_one.api_key.label": "مفتاح API لـ TypeSafe",
  "st.system_one.watch.label": "التحقق من المراقبة المجدولة",
  "st.system_one.completion.label": "التحقق من إتمام المهام المجدولة",
  "st.system_one.security_html": "يرسل المهمة وأدلة محدودة من الصفحة إلى TypeSafe. يُحفظ المفتاح محليًا كنص عادي وقد يكون الاستخدام مدفوعًا. يعطّل Strict Secret Mode خدمة Jev.",
  ...
  "sp.selection_scope.restore_description": "استعادة المحادثة تزيل حدود النص المحدد. يمكن للرسائل اللاحقة استخدام الصفحة الحالية وأدوات المتصفح والملفات والمرفقات والمحادثة السابقة الكاملة، بما في ذلك سياق الصفحة.",
  ...
  'tool.set_checked': "تحديث مربع الاختيار",
  'tool.hover': "تمرير المؤشر",
  'tool.drag_drop': "سحب العنصر وإفلاته",
  'tool.press_keys': "الضغط على المفاتيح",
  'tool.press_keys.keys': "الضغط على {keys}",
  'tool.find_text': "البحث عن نص",
  'tool.find_text.text': "البحث عن «{text}»",
  'tool.upload_file': "رفع ملف",
  'tool.download_files': "تنزيل ملفات",
  'tool.download_media': "تنزيل الوسائط",
  'tool.download_resource': 'تنزيل الملف',
  'tool.check_downloads': "التحقق من التنزيلات",
  'tool.read_downloaded_file': "قراءة الملف المنزّل",
  'tool.read_frame': "قراءة الإطار",
  'tool.get_frames': 'سرد الإطارات',
  'tool.solve_captcha': "حل التحقق",
  'tool.clarify': "طلب توضيح",
  'tool.get_window_info': "فحص النافذة",
  'tool.resize_window': "تغيير حجم النافذة",
  'tool.inspect_viewport': "فحص مساحة العرض",
  'tool.scratchpad_write': "تحديث الملاحظات",
  'tool.progress_update': "تحديث التقدم",
  'tool.progress_read': "قراءة التقدم",
  'tool.verify_form': "التحقق من النموذج",
  'tool.chat_observe': "مراقبة المحادثة",
  ...
  'tool.staged_screenshot': 'وصف لقطة الشاشة',
  'tool.done': 'الإنهاء',
  ...
  "st.display.auto_screenshot.desc": "التقط لقطة شاشة لنافذة العرض تلقائيًا بعد أن يتصرف الوكيل في الصفحة، لكي يرى مسار الرؤية المحدد ما تغيّر. يستهلك ذلك مزيدًا من الرموز. إذا لم تتوفر الرؤية، يتم تخطي الإثراء وتستمر المهمة مع إشعار بالحالة.",
  ...
  'st.display.completion_flash_tab.label': "وميض التبويب المكتمل",
  'st.display.completion_flash_tab.desc': "عند انتهاء مهمة في تبويب غادرته، يومض عنوان ذلك التبويب وأيقونته لتعرف بنظرة واحدة أي تبويب اكتمل.",
  ...
  "st.vision.local.testing": "جارٍ تحميل الرؤية المحلية واختبارها…",
  ...
  'tr.lineage.standalone': 'تشغيل مستقل',
  'tr.lineage.incomplete': 'قد تكون بعض التشغيلات المرتبطة خارج القائمة المحمّلة.',
  'tr.lineage.toggle': 'توسيع أو طي التشغيلات الفرعية',
  'tr.lineage.missing_parent': 'تشغيل الأصل غير موجود في القائمة المحمّلة.',
  'tr.lineage.ambiguous_parent': 'رابط الأصل غير واضح؛ تبقى هذه التشغيلات كجذر.',
  'tr.lineage.cross_session_parent': 'ينتمي الأصل إلى جلسة أخرى؛ تبقى هذه التشغيلات كجذر.',
  'tr.lineage.duplicate_id': 'معرّف تشغيل مكرر؛ تبقى هذه التشغيلات كجذر.',
  'tr.lineage.cycle': 'اكتُشفت دورة؛ تبقى هذه التشغيلات كجذر.',
  ...
  "st.tab.multimodal": "النماذج المساعدة",
  ...
  "st.display.strict_secret.desc": "رفض اقتباس بيانات الاعتماد (كلمات المرور، مفاتيح API، الرموز، رموز OTP) في الملخّصات أو نص المساعد — حتى عندما تطلبها صراحةً. مفيد إذا كنت تشارك ملفات التتبّع أو تشارك شاشتك بانتظام. مُعطّل افتراضيًا ليتمكّن الوكيل من تكرار القيمة الدقيقة التي تطلبها عند الحاجة. فعّله (الإعدادات ← الأمان) عندما تريد إبقاء ملخّصات `done` مرتّبة وتجنّب تكرار بيانات الاعتماد.",
  ...
  "st.transcription.heading": "تحويل الكلام إلى نص",
  ...
  'st.display.cloud_bridge.desc': 'صِل وحدة تحكم محلية واحدة بملف Chromium هذا باستخدام المنفذ 17374. يمكن تفعيل جسر واحد فقط في كل مرة، وتظل مطالبات الأذونات القياسية سارية.',
  ...
  "st.sync.lede_html": "<strong>أعضاء WebBrain Compass فقط.</strong> مزامنة الذكريات والملء التلقائي للملف الشخصي وإعدادات موفر مفتاح واجهة برمجة التطبيقات عبر الأجهزة. يتم تشفير كل شيء باستخدام كلمة مرور المزامنة الخاصة بك قبل التحميل. لا يستطيع WebBrain قراءته أو استعادته. لا تتم مزامنة سجل الدردشة وتسجيلات الدخول عبر OAuth.",
  "st.sync.email.label": "البريد الإلكتروني WebBrain Compass",
  ...
  "st.sync.status.subscription": "عضوية WebBrain Compass مطلوبة للمزامنة المشفرة.",
  "st.sync.status.error": "المزامنة المشفرة تحتاج إلى الاهتمام.",
  "st.sync.status.auth_required": "قم بتسجيل الدخول باستخدام البريد الإلكتروني WebBrain Compass الخاص بك لاستخدام المزامنة المشفرة.",
  ...
  "st.sync.validation.email_required": "أدخل البريد الإلكتروني الخاص بفواتير WebBrain Compass.",
  ...
  "st.sync.auth.check_email": "تحقق من بريدك الإلكتروني، ووافق على رابط تسجيل الدخول إلى WebBrain Compass، ثم ارجع إلى هنا.",
