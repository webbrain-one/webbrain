...
export default {
  ...
  "st.system_one.desc_html": "Zamanlanmış izlemeler ve görev tamamlanması için ek doğrulama.",
  "st.system_one.enabled.label": "Jev’i etkinleştir",
  "st.system_one.api_key.label": "TypeSafe API anahtarı",
  "st.system_one.watch.label": "Zamanlanmış izlemeleri doğrula",
  "st.system_one.completion.label": "Zamanlanmış görev tamamlanmasını doğrula",
  "st.system_one.security_html": "Görevi ve sınırlı sayfa kanıtını TypeSafe’e gönderir. Anahtarınız yerelde düz metin olarak saklanır ve kullanım ücretli olabilir. Strict Secret Mode, Jev’i kapatır.",
  ...
  'ob.btn.start': 'Başla',
  'ob.cloud.body': 'WebBrain Compass günlük ücretsiz tahsis ile hazır. Seçilen Compass sohbetleri, WebBrain\'i Geliştir Yardımı varsayılan olarak açıkken WebBrain\'i geliştirmek için saklanabilir ve kullanılabilir. Bunu Ayarlar → Genel olarak kapatabilirsiniz.',
  ...
  'tool.set_checked': "Onay kutusu güncelleniyor",
  'tool.hover': "Üzerine geliniyor",
  'tool.drag_drop': "Öğe sürükleniyor",
  'tool.press_keys': "Tuşlara basılıyor",
  'tool.press_keys.keys': "{keys} tuşuna basılıyor",
  'tool.find_text': "Metin aranıyor",
  'tool.find_text.text': "«{text}» aranıyor",
  'tool.upload_file': "Dosya yükleniyor",
  'tool.download_files': "Dosyalar indiriliyor",
  'tool.download_media': "Medya indiriliyor",
  'tool.download_resource': 'Dosya indiriliyor',
  'tool.check_downloads': "İndirmeler kontrol ediliyor",
  'tool.read_downloaded_file': "İndirilen dosya okunuyor",
  'tool.read_frame': "Çerçeve okunuyor",
  'tool.get_frames': 'Çerçeveler listeleniyor',
  'tool.solve_captcha': "Doğrulama çözülüyor",
  'tool.clarify': "Açıklama isteniyor",
  'tool.get_window_info': "Pencere kontrol ediliyor",
  'tool.resize_window': "Pencere yeniden boyutlandırılıyor",
  'tool.inspect_viewport': "Görünüm alanı inceleniyor",
  'tool.scratchpad_write': "Notlar güncelleniyor",
  'tool.progress_update': "İlerleme güncelleniyor",
  'tool.progress_read': "İlerleme okunuyor",
  'tool.verify_form': "Form doğrulanıyor",
  'tool.chat_observe': "Sohbet izleniyor",
  ...
  'tool.staged_screenshot': 'Ekran görüntüsü açıklanıyor',
  ...
  "st.vision.local.testing": "Yerel görüntü modeli yükleniyor ve test ediliyor…",
  ...
  "st.tab.multimodal": "Yardımcı Modeller",
  ...
  "st.transcription.heading": "Konuşmayı metne dönüştürme",
  ...
  "st.imagegen.connected": "Bağlandı! Model: {model}",
  "st.imagegen.failed": "Başarısız: {error}",
  "st.imagegen.fill_required": "Önce API anahtarını ve modeli doldurun.",
  ...
  'st.display.cloud_bridge.desc': '17374 numaralı bağlantı noktasını kullanarak bu Chromium profiline bir yerel denetleyici bağlayın. Aynı anda yalnızca bir köprü etkin olabilir ve standart izin istemleri geçerliliğini korur.',
  ...
  "st.display.webmcp.desc": "WebBrain'in desteklenen Chrome sayfalarının sunduğu yapılandırılmış araçları keşfetmesine ve çalıştırmasına izin ver. Etkinleştirildiğinde deneysel WebMCP araçları ve yönlendirmesi model bağlamına eklenir. Varsayılan olarak açıktır.",
  ...
  "st.sync.lede_html": "<strong>Yalnızca WebBrain Compass üyeleri.</strong> Cihazlar arasında anıları, profil otomatik doldurmayı ve API anahtarı sağlayıcı ayarlarını senkronize edin. Yüklemeden önce her şey senkronizasyon şifrenizle şifrelenir. WebBrain bunu okuyamaz veya kurtaramaz. Sohbet geçmişi ve OAuth oturum açma işlemleri senkronize edilmez.",
  "st.sync.email.label": "WebBrain Compass e-postası",
  ...
  "st.sync.status.subscription": "Şifreli senkronizasyon için WebBrain Compass üyeliği gereklidir.",
  "st.sync.status.error": "Şifreli senkronizasyona dikkat edilmesi gerekiyor.",
  "st.sync.status.auth_required": "Şifreli senkronizasyonu kullanmak için WebBrain Compass e-postanızla oturum açın.",
  ...
  "st.sync.validation.email_required": "WebBrain Compass faturalandırma e-postanızı girin.",
  ...
  "st.sync.auth.check_email": "E-postanızı kontrol edin, WebBrain Compass oturum açma bağlantısını onaylayın ve ardından buraya geri dönün.",
