...
export default {
  ...
  'sp.ui_scale.reset': 'Restablecer',
  'st.display.ui_scale.label': 'Zoom de la interfaz de la extensión',
  'st.display.ui_scale.decrease': 'Reducir el zoom de la interfaz',
  'st.display.ui_scale.increase': 'Aumentar el zoom de la interfaz',
  'st.display.ui_scale.reset': 'Restablecer',
  'st.display.ui_scale.desc': 'Cambia el tamaño del panel lateral y de la ventana de chat independiente sin cambiar el zoom de la página.',
  'st.display.ui_scale.shortcuts': 'Atajos exclusivos: {shortcuts}',
  'st.display.ui_scale.shortcuts_none': 'Sin asignar',
  'st.display.ui_scale.manage_shortcuts': 'Personalizar atajos',
  ...
  "st.system_one.desc_html": "Verificación adicional de seguimientos y tareas programadas.",
  "st.system_one.enabled.label": "Activar Jev",
  "st.system_one.api_key.label": "Clave API de TypeSafe",
  "st.system_one.watch.label": "Verificar seguimientos programados",
  "st.system_one.completion.label": "Verificar tareas programadas completadas",
  "st.system_one.security_html": "Envía la tarea y pruebas limitadas de la página a TypeSafe. La clave se guarda localmente en texto plano. El uso puede tener coste. Strict Secret Mode desactiva Jev.",
  ...
  'install.showcase.ask.title': "Pregunta a cualquier página. Quédate con lo útil.",
  'install.showcase.ask.body': "Respuestas claras de páginas desordenadas. Solo lectura por defecto.",
  'install.showcase.act.title': "Dile al navegador qué hacer.",
  'install.showcase.model.title': "Usa el modelo en el que confías.",
  'install.showcase.model.body': "Local, en la nube o con tus propias claves — cambia cuando quieras.",
  'install.showcase.apocalypse.body': "Conocimiento sin conexión, bajo tu control. Descarga lo esencial mientras aún puedes.",
  ...
  "sp.btn.clear_short": "Nueva conversación",
  "sp.btn.history_short": "Historial",
  ...
  'tool.hover': "Pasando el cursor",
  'tool.drag_drop': "Arrastrando elemento",
  'tool.press_keys': "Pulsando teclas",
  'tool.press_keys.keys': "Pulsando {keys}",
  'tool.find_text': "Buscando texto",
  'tool.find_text.text': "Buscando «{text}»",
  'tool.upload_file': "Subiendo archivo",
  'tool.download_files': "Descargando archivos",
  'tool.download_media': "Descargando medios",
  'tool.download_resource': 'Descargando archivo',
  'tool.check_downloads': "Comprobando descargas",
  'tool.read_downloaded_file': "Leyendo archivo descargado",
  'tool.read_frame': "Leyendo marco",
  'tool.get_frames': 'Listando marcos',
  'tool.solve_captcha': "Resolviendo verificación",
  'tool.clarify': "Solicitando aclaración",
  'tool.get_window_info': "Comprobando ventana",
  'tool.resize_window': "Redimensionando ventana",
  'tool.inspect_viewport': "Inspeccionando área visible",
  'tool.scratchpad_write': "Actualizando notas",
  'tool.progress_update': "Actualizando progreso",
  'tool.progress_read': "Leyendo progreso",
  'tool.verify_form': "Verificando formulario",
  'tool.chat_observe': "Observando chat",
  'tool.chat_send': "Enviando mensaje",
  'tool.load_skill': "Cargando habilidad",
  'tool.execute_webmcp_tool': "Ejecutando herramienta WebMCP",
  'tool.list_webmcp_tools': 'Listando herramientas WebMCP',
  'tool.beep': "Emitiendo sonido de alerta",
  ...
  'tool.staged_screenshot': 'Describiendo captura',
  ...
  "st.display.auto_screenshot.desc": "Captura automáticamente una imagen de la ventana después de que el agente actúe en la página, para que la ruta de visión seleccionada vea qué cambió. Consume más tokens. Si la visión no está disponible, se omite el enriquecimiento y la tarea continúa con un aviso de estado.",
  ...
  "st.vision.local.testing": "Cargando y probando la visión local…",
  ...
  "st.transcription.heading": "Voz a texto",
  ...
  "st.imagegen.failed": "Error: {error}",
  "st.imagegen.fill_required": "Rellena primero la clave de API y el modelo.",
  ...
  'st.display.cloud_bridge.desc': 'Conecta un controlador local a este perfil de Chromium mediante el puerto 17374. Solo puede haber un puente activo a la vez y los avisos de permisos estándar siguen aplicándose.',
  ...
  "st.display.webmcp.desc": "Permite que WebBrain descubra y ejecute herramientas estructuradas expuestas por páginas de Chrome compatibles. Al activarlo, se añaden herramientas WebMCP experimentales y sus indicaciones al contexto del modelo. Activado por defecto.",
  ...
  "st.sync.status.subscription": "Se requiere membresía de WebBrain Compass para la sincronización cifrada.",
  "st.sync.status.error": "La sincronización cifrada necesita atención.",
  "st.sync.status.auth_required": "Inicie sesión con su correo electrónico de WebBrain Compass para utilizar la sincronización cifrada.",
  ...
  "st.sync.validation.email_required": "Ingrese su correo electrónico de facturación de WebBrain Compass.",
  ...
  "st.sync.auth.check_email": "Revise su correo electrónico, apruebe el enlace de inicio de sesión de WebBrain Compass y luego regrese aquí.",
