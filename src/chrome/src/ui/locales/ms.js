...
export default {
  ...
  "st.system_one.desc_html": "Pengesahan tambahan bagi pemantauan berjadual dan penyelesaian tugas.",
  "st.system_one.enabled.label": "Dayakan Jev",
  "st.system_one.api_key.label": "Kunci API TypeSafe",
  "st.system_one.watch.label": "Sahkan pemantauan berjadual",
  "st.system_one.completion.label": "Sahkan penyelesaian tugas berjadual",
  "st.system_one.security_html": "Menghantar tugas dan bukti halaman terhad kepada TypeSafe. Kunci disimpan secara setempat sebagai teks biasa dan penggunaan mungkin berbayar. Strict Secret Mode melumpuhkan Jev.",
  ...
  'sp.activity.communicating': 'Sedang berkomunikasi...',
  'sp.activity.thinking_more': 'Sedang memikirkannya dengan lebih mendalam...',
  'sp.activity.working_next': 'Sedang mengusahakan langkah seterusnya...',
  'sp.activity.coordinating_next': 'Sedang menyelaraskan langkah seterusnya...',
  'sp.activity.checking_next': 'Sedang menyemak langkah berikutnya...',
  'sp.activity.preparing_next': 'Sedang menyediakan tindakan seterusnya...',
  'sp.activity.connecting_pieces': 'Sedang menghubungkan maklumat...',
  'sp.activity.reviewing_progress': 'Sedang menyemak kemajuan...',
  'sp.activity.toggle_history': 'Tunjukkan atau sembunyikan sejarah aktiviti',
  ...
  'tool.research_url.url': 'Menyelidik {url}',
  'tool.research_url': "Menyelidik halaman",
  'tool.read_pdf': "Membaca PDF",
  'tool.read_youtube_transcript': "Membaca transkrip video",
  'tool.set_checked': "Mengemas kini kotak pilihan",
  'tool.hover': "Melayang kursor",
  'tool.drag_drop': "Menyeret elemen",
  'tool.press_keys': "Menekan kekunci",
  'tool.press_keys.keys': "Menekan {keys}",
  'tool.find_text': "Mencari teks",
  'tool.find_text.text': "Mencari \"{text}\"",
  'tool.upload_file': "Memuat naik fail",
  'tool.download_files': "Memuat turun fail",
  'tool.download_media': "Memuat turun media",
  'tool.download_resource': 'Memuat turun fail',
  'tool.check_downloads': "Memeriksa muat turun",
  'tool.read_downloaded_file': "Membaca fail dimuat turun",
  'tool.read_frame': "Membaca bingkai",
  'tool.get_frames': 'Menyenaraikan bingkai',
  'tool.solve_captcha': "Menyelesaikan pengesahan",
  'tool.clarify': "Meminta penjelasan",
  'tool.get_window_info': "Memeriksa tetingkap",
  'tool.resize_window': "Mengubah saiz tetingkap",
  'tool.inspect_viewport': "Memeriksa ruang pandang",
  'tool.scratchpad_write': "Mengemas kini nota",
  'tool.progress_update': "Mengemas kini kemajuan",
  'tool.progress_read': "Membaca kemajuan",
  'tool.verify_form': "Mengesahkan borang",
  'tool.chat_observe': "Memerhati sembang",
  ...
  'tool.staged_screenshot': 'Memerihalkan tangkapan skrin',
  ...
  "st.display.auto_screenshot.desc": "Tangkap tangkapan skrin viewport secara automatik selepas ejen bertindak pada halaman supaya laluan penglihatan yang dipilih dapat melihat perubahan. Ini menggunakan lebih banyak token. Jika penglihatan tidak tersedia, pengayaan dilangkau dan tugas diteruskan dengan notis status.",
  ...
  "st.vision.local.testing": "Memuatkan dan menguji penglihatan setempat…",
  ...
  "st.tab.multimodal": "Model Bantuan",
  ...
  "st.transcription.heading": "Pertuturan kepada teks",
  ...
  'st.display.cloud_bridge.desc': 'Sambungkan satu pengawal setempat ke profil Chromium ini menggunakan port 17374. Hanya satu jambatan boleh aktif pada satu masa dan gesaan kebenaran standard masih digunakan.',
  ...
  'st.display.always_allow_api_mutations.desc': "Benarkan WebBrain menggunakan POST, PUT, PATCH dan DELETE melalui fetch_url atau research_url tanpa memerlukan /allow-api dalam setiap perbualan. Panduan mengutamakan UI dan semakan pengesahan masih terpakai. Dihidupkan secara lalai.",
  'st.display.api_mutation_observer.label': 'Pemerhati mutasi API',
  'st.display.api_mutation_observer.desc': 'Perhatikan URL dan metode permintaan XHR/fetch tab yang sama supaya WebBrain dapat mengesan tindakan UI berulang dan mencadangkan corak pintasan API. Dihidupkan secara lalai.',
  ...
  "st.display.webmcp.desc": "Benarkan WebBrain menemui dan menjalankan alat berstruktur yang disediakan oleh halaman Chrome yang disokong. Mengaktifkannya menambah alat WebMCP eksperimental dan panduannya pada konteks model. Dihidupkan secara lalai.",
  ...
  "st.display.help_improve.desc_html": "Benarkan interaksi WebBrain Compass terpilih disimpan dan digunakan untuk penilaian, penambahbaikan, penalaan halus dan latihan. Dihidupkan secara lalai. Matikan untuk menghalang interaksi Compass pada masa hadapan daripada digunakan bagi tujuan tersebut. <u>WebBrain hanya mengumpul permintaan model setempat dan API anda sendiri daripada penyedia yang anda hidupkan “Kongsi pertanyaan untuk penyelidikan”.</u> <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Dasar privasi →</a>",
  "st.providers.webbrain_data_use.body": "Penggunaan harian percuma WebBrain Compass disertakan. Semasa Bantu Tingkatkan WebBrain dihidupkan secara lalai, perbualan Compass terpilih mungkin disimpan dan digunakan untuk penilaian, penambahbaikan, penalaan halus dan latihan. Matikan di Umum → Lanjutan untuk mengecualikan interaksi Compass pada masa hadapan daripada penggunaan tersebut. <u>WebBrain hanya mengumpul permintaan model setempat dan API anda sendiri jika anda menghidupkan opsyen “Kongsi pertanyaan untuk penyelidikan” penyedia ini.</u> {privacyLink}. Untuk penggunaan tambahan, langgan di {subscribeLink}. Urus pengebilan di {accountLink}.",
  'st.providers.share_research.label': "Kongsi pertanyaan untuk penyelidikan",
  'st.providers.share_research.hint': "Menghantar gesaan dan respons daripada penyedia ini kepada WebBrain untuk penilaian dan penambahbaikan, termasuk penyedia dan model yang digunakan. Imej dan lampiran binari dibuang dan teks dipangkas sebelum dikongsi; baki teks dihantar seadanya.",
  'st.providers.share_research.confirm': "Kongsi pertanyaan daripada penyedia ini dengan WebBrain untuk penyelidikan?\n\nJika dihidupkan, gesaan, respons dan interaksi alat anda dengan penyedia ini akan dihantar kepada WebBrain untuk penilaian dan penambahbaikan, berserta nama penyedia dan model. Teks dihantar seadanya selepas imej dibuang dan kandungan panjang dipangkas, jadi elakkan berkongsi data peribadi yang sensitif. Anda boleh mematikannya pada bila-bila masa untuk menghentikan perkongsian.",
  ...
  "st.sync.status.subscription": "Keahlian WebBrain Compass diperlukan untuk penyegerakan yang disulitkan.",
  "st.sync.status.error": "Penyegerakan yang disulitkan memerlukan perhatian.",
  "st.sync.status.auth_required": "Log masuk dengan e-mel WebBrain Compass anda untuk menggunakan penyegerakan yang disulitkan.",
  ...
  "st.sync.validation.email_required": "Masukkan e-mel pengebilan WebBrain Compass anda.",
  ...
  "st.sync.auth.check_email": "Semak e-mel anda, luluskan pautan log masuk WebBrain Compass, kemudian kembali ke sini.",
