...
export default {
  ...
  "st.display.help_improve.desc_html": "Benarkan interaksi WebBrain Cloud terpilih disimpan dan digunakan untuk penilaian, penambahbaikan, penalaan halus dan latihan. Dihidupkan secara lalai. Matikan untuk menghalang interaksi Cloud pada masa hadapan daripada digunakan bagi tujuan tersebut. WebBrain tidak pernah mengumpul permintaan model setempat atau permintaan yang dihantar terus menggunakan kelayakan API anda sendiri. <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Dasar privasi →</a>",
  "st.providers.webbrain_data_use.body": "Penggunaan harian percuma WebBrain Cloud disertakan. Semasa Bantu Tingkatkan WebBrain dihidupkan secara lalai, perbualan Cloud terpilih mungkin disimpan dan digunakan untuk penilaian, penambahbaikan, penalaan halus dan latihan. Matikan di Umum → Lanjutan untuk mengecualikan interaksi Cloud pada masa hadapan daripada penggunaan tersebut. WebBrain tidak pernah mengumpul permintaan model setempat atau permintaan yang dihantar terus menggunakan kelayakan API anda sendiri. {privacyLink}. Untuk penggunaan tambahan, langgan di {subscribeLink}. Urus pengebilan di {accountLink}.",
