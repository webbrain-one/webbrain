...
export default {
  ...
  'st.skills.source.built_in': '기본 내장',
  ...
  'sp.scratchpad.edit_empty': '/edit-scratchpad 뒤에 텍스트를 추가하여 스크래치패드에 추가하세요.',
  'sp.plan.title': '계획 검토',
  ...
  "sp.memory.remember_empty": "/remember 뒤에 기억할 내용을 입력하세요.",
  "sp.memory.remembered": "사용자 메모리에 저장했습니다.",
  "sp.memory.forget_empty": "/forget-memory 뒤에 메모리 ID를 붙여 넣으세요.",
  ...
  "st.memory.desc_html": "답변 스타일, 반복되는 워크플로 선택, 지속적인 프로필 정보 또는 현재 작업 이후에도 적용해야 하는 확인 답변 등 WebBrain이 기억할 안정적인 기본 설정을 저장합니다. <code>/remember</code>를 명시적으로 사용하면 즉시 저장되며, 자동 학습은 선택 사항이고 한 턴이 완료된 후에만 실행됩니다.",
