...
export default {
  ...
  'sp.ui_scale.reset': '초기화',
  'st.display.ui_scale.label': '확장 프로그램 UI 확대/축소',
  'st.display.ui_scale.decrease': '확장 프로그램 UI 축소',
  'st.display.ui_scale.increase': '확장 프로그램 UI 확대',
  'st.display.ui_scale.reset': '초기화',
  'st.display.ui_scale.desc': '페이지 확대/축소는 변경하지 않고 사이드 패널과 별도 채팅 창의 크기를 조정합니다.',
  'st.display.ui_scale.shortcuts': '전용 단축키: {shortcuts}',
  'st.display.ui_scale.shortcuts_none': '지정되지 않음',
  'st.display.ui_scale.manage_shortcuts': '단축키 사용자 지정',
  ...
  "st.system_one.desc_html": "예약된 모니터링과 작업 완료를 추가로 검증합니다.",
  "st.system_one.enabled.label": "Jev 활성화",
  "st.system_one.api_key.label": "TypeSafe API 키",
  "st.system_one.watch.label": "예약 모니터링 검증",
  "st.system_one.completion.label": "예약 작업 완료 검증",
  "st.system_one.security_html": "작업과 제한된 페이지 증거를 TypeSafe로 보냅니다. 키는 로컬에 일반 텍스트로 저장되며 사용 요금이 발생할 수 있습니다. Strict Secret Mode에서는 Jev가 비활성화됩니다.",
  ...
  'sp.btn.settings': '설정',
  "sp.btn.clear": "새 대화",
  "sp.btn.clear_short": "새 대화",
  "sp.btn.history_short": "기록",
  ...
  'sp.activity.communicating': '소통 중...',
  'sp.activity.thinking_more': '조금 더 생각하고 있습니다...',
  'sp.activity.working_next': '다음 단계를 진행하고 있습니다...',
  'sp.activity.coordinating_next': '다음 단계를 조율하고 있습니다...',
  'sp.activity.checking_next': '다음 작업을 확인하고 있습니다...',
  'sp.activity.preparing_next': '다음 작업을 준비하고 있습니다...',
  'sp.activity.connecting_pieces': '정보를 연결하고 있습니다...',
  'sp.activity.reviewing_progress': '진행 상황을 검토하고 있습니다...',
  'sp.activity.toggle_history': '활동 기록 표시 또는 숨기기',
  ...
  'tool.set_checked': "체크박스 업데이트 중",
  'tool.hover': "마우스 올리는 중",
  'tool.drag_drop': "요소 드래그 중",
  'tool.press_keys': "키 입력 중",
  'tool.press_keys.keys': "{keys} 입력 중",
  'tool.find_text': "텍스트 찾는 중",
  'tool.find_text.text': "\"{text}\" 찾는 중",
  'tool.upload_file': "파일 업로드 중",
  'tool.download_files': "파일 다운로드 중",
  'tool.download_media': "미디어 다운로드 중",
  'tool.download_resource': '파일 다운로드 중',
  'tool.check_downloads': "다운로드 확인 중",
  'tool.read_downloaded_file': "다운로드한 파일 읽는 중",
  'tool.read_frame': "프레임 읽는 중",
  'tool.get_frames': '프레임 나열 중',
  'tool.solve_captcha': "보안 확인 해결 중",
  'tool.clarify': "명확한 정보 요청 중",
  'tool.get_window_info': "창 정보 확인 중",
  'tool.resize_window': "창 크기 조정 중",
  'tool.inspect_viewport': "뷰포트 검사 중",
  'tool.scratchpad_write': "메모 업데이트 중",
  'tool.progress_update': "진행 상황 업데이트 중",
  'tool.progress_read': "진행 상황 확인 중",
  'tool.verify_form': "양식 확인 중",
  'tool.chat_observe': "채팅 관찰 중",
  ...
  'tool.staged_screenshot': '스크린샷 설명 중',
  'tool.done': '마무리 중',
  ...
  "st.vision.local.testing": "로컬 비전을 불러와 테스트하는 중…",
  ...
  'tr.lineage.standalone': '독립 실행',
  'tr.lineage.incomplete': '관련 실행 일부가 로드된 목록 밖에 있을 수 있습니다.',
  'tr.lineage.toggle': '하위 실행 펼치기 또는 접기',
  'tr.lineage.missing_parent': '상위 실행이 로드된 목록에 없습니다.',
  'tr.lineage.ambiguous_parent': '상위 링크가 모호하여 이 실행은 루트로 유지됩니다.',
  'tr.lineage.cross_session_parent': '상위 실행이 다른 세션에 속하므로 이 실행은 루트로 유지됩니다.',
  'tr.lineage.duplicate_id': '실행 ID가 중복되어 이 실행은 루트로 유지됩니다.',
  'tr.lineage.cycle': '순환이 감지되어 이 실행은 루트로 유지됩니다.',
  ...
  "st.display.strict_secret.desc": "요약이나 어시스턴트 텍스트에 자격 증명(비밀번호, API 키, 토큰, OTP)을 인용하기를 거부합니다 — 명시적으로 요청하더라도 마찬가지입니다. 트레이스 파일을 자주 공유하거나 화면을 공유한다면 유용합니다. 기본값은 꺼짐: 필요할 때 에이전트가 요청한 정확한 값을 그대로 알려줄 수 있습니다. `done` 요약을 깔끔하게 유지하고 자격 증명이 반복되지 않게 하려면 켜세요 (설정 → 보안).",
  ...
  "st.transcription.heading": "음성을 텍스트로",
  ...
  'st.display.cloud_bridge.desc': '포트 17374를 사용해 로컬 컨트롤러 하나를 이 Chromium 프로필에 연결합니다. 한 번에 하나의 브리지만 활성화할 수 있으며 표준 권한 확인은 계속 적용됩니다.',
  ...
  "st.display.webmcp.desc": "지원되는 Chrome 페이지가 제공하는 구조화된 도구를 WebBrain이 검색하고 실행하도록 허용합니다. 활성화하면 실험적 WebMCP 도구와 안내가 모델 컨텍스트에 추가됩니다. 기본값은 켜짐입니다.",
  ...
  "st.sync.lede_html": "<strong>WebBrain Compass 회원 전용.</strong> 여러 기기에서 추억, 프로필 자동 완성, API 키 제공자 설정을 동기화합니다. 업로드하기 전에 모든 것이 동기화 비밀번호로 암호화됩니다. WebBrain은 이를 읽거나 복구할 수 없습니다. 채팅 기록과 OAuth 로그인은 동기화되지 않습니다.",
  "st.sync.email.label": "WebBrain Compass 이메일",
  ...
  "st.sync.status.subscription": "암호화된 동기화를 위해서는 WebBrain Compass 멤버십이 필요합니다.",
  "st.sync.status.error": "암호화된 동기화에는 주의가 필요합니다.",
  "st.sync.status.auth_required": "암호화된 동기화를 사용하려면 WebBrain Compass 이메일로 로그인하세요.",
  ...
  "st.sync.validation.email_required": "WebBrain Compass 청구 이메일을 입력하세요.",
  ...
  "st.sync.auth.check_email": "이메일을 확인하고 WebBrain Compass 로그인 링크를 승인한 후 여기로 돌아오세요.",
