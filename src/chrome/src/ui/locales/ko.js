...
export default {
  ...
  'sp.plan.intent_unavailable': '플래너가 한 번의 복구 후에도 유효한 구조화 출력을 반환하지 못했습니다. 이 턴은 읽기 전용 모드로 계속합니다.',
  ...
  'st.display.plan_before_act.desc': 'Act 및 Dev 모드는 도구 실행 전에 항상 구조화된 의도 확인을 수행합니다. 시도(기본값)는 전체 계획도 만들지만 짧은 후속 요청에서는 최근 승인된 계획을 재사용할 수 있습니다. 엄격 모드는 매 턴 전체 계획을 만듭니다. 의도나 계획이 한 번의 복구 후에도 유효하지 않으면 시도는 읽기 전용 턴으로 전환하고 엄격 모드는 도구 실행 전에 중지합니다.',
