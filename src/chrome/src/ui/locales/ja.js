...
export default {
  ...
  'st.display.plan_before_act.desc': 'Act と Dev はツール実行前に必ず構造化された意図確認を行います。試行（デフォルト）は完全な計画も作成しますが、短いフォローアップでは直近に承認された計画を再利用できます。厳格は毎ターン完全な計画を作成します。意図または計画が1回の修復後も無効な場合、試行は読み取り専用ターンに切り替え、厳格はツール実行前に停止します。',
