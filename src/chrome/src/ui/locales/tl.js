...
export default {
  ...
  'st.display.plan_before_act.desc': 'Palaging nagsasagawa ang mga mode na Kumilos at Dev ng nakaayos na pagsusuri ng layunin bago gumamit ng mga tool. Gumagawa rin ng buong plano ang Subukan (default), ngunit maaari nitong gamitin muli ang kamakailang inaprubahang plano para sa maikling follow-up; gumagawa ng buong plano ang Mahigpit sa bawat turno. Kung hindi pa rin valid ang layunin o plano matapos ang isang pag-aayos, lilipat ang Subukan sa read-only na turn at hihinto ang Mahigpit bago gumamit ng mga tool.',
