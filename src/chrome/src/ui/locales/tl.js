...
export default {
  ...
  "st.system_one.desc_html": "Dagdag na pagtiyak sa nakaiskedyul na pagsubaybay at pagkumpleto ng gawain.",
  "st.system_one.enabled.label": "Paganahin ang Jev",
  "st.system_one.api_key.label": "TypeSafe API key",
  "st.system_one.watch.label": "Tiyakin ang nakaiskedyul na pagsubaybay",
  "st.system_one.completion.label": "Tiyakin ang pagkumpleto ng nakaiskedyul na gawain",
  "st.system_one.security_html": "Ipinapadala ang gawain at limitadong ebidensiya ng pahina sa TypeSafe. Lokal na nakaimbak ang key bilang plain text at maaaring may bayad ang paggamit. Hindi gumagana ang Jev sa Strict Secret Mode.",
  ...
  'tool.set_checked': "Ina-update ang checkbox",
  'tool.hover': "Tinatapat ang cursor",
  'tool.drag_drop': "Hinihila ang elemento",
  'tool.press_keys': "Pindot ng mga key",
  'tool.press_keys.keys': "Pinipindot ang {keys}",
  'tool.find_text': "Naghahanap ng teksto",
  'tool.find_text.text': "Naghahanap ng \"{text}\"",
  'tool.upload_file': "Nag-a-upload ng file",
  'tool.download_files': "Nagda-download ng mga file",
  'tool.download_media': "Nagda-download ng media",
  'tool.download_resource': 'Nagda-download ng file',
  'tool.check_downloads': "Sinusuri ang mga download",
  'tool.read_downloaded_file': "Binabasa ang na-download na file",
  'tool.read_frame': "Binabasa ang frame",
  'tool.get_frames': 'Inililista ang mga frame',
  'tool.solve_captcha': "Nilulutas ang pag-verify",
  'tool.clarify': "Hinihingi ang paglilinaw",
  'tool.get_window_info': "Sinusuri ang window",
  'tool.resize_window': "Binabago ang laki ng window",
  'tool.inspect_viewport': "Sinusuri ang viewport",
  'tool.scratchpad_write': "Ina-update ang mga tala",
  'tool.progress_update': "Ina-update ang progreso",
  'tool.progress_read': "Binabasa ang progreso",
  'tool.verify_form': "Bini-verify ang form",
  'tool.chat_observe': "Inoobserbahan ang chat",
  ...
  'tool.staged_screenshot': 'Inilalarawan ang screenshot',
  'tool.done': 'Tinatapos',
  ...
  "st.vision.local.testing": "Nilo-load at sinusubukan ang lokal na vision…",
  ...
  "st.tab.multimodal": "Mga Pantulong na Modelo",
  ...
  "st.transcription.heading": "Pagsasalita tungo sa teksto",
  ...
  'st.display.cloud_bridge.desc': 'Ikonekta ang isang lokal na controller sa Chromium profile na ito gamit ang port 17374. Isang bridge lang ang maaaring aktibo sa isang pagkakataon, at nalalapat pa rin ang mga karaniwang prompt ng pahintulot.',
  ...
  "st.display.webmcp.desc": "Payagan ang WebBrain na tumuklas at magpatakbo ng mga structured tool na inilalantad ng mga suportadong Chrome page. Kapag in-enable, idinaragdag ang mga eksperimental na WebMCP tool at gabay sa context ng model. Naka-on bilang default.",
  ...
  "st.sync.status.subscription": "Kinakailangan ang membership sa WebBrain Compass para sa naka-encrypt na pag-sync.",
  "st.sync.status.error": "Ang naka-encrypt na pag-sync ay nangangailangan ng pansin.",
  "st.sync.status.auth_required": "Mag-sign in gamit ang iyong WebBrain Compass email upang magamit ang naka-encrypt na pag-sync.",
  ...
  "st.sync.validation.email_required": "Ilagay ang iyong email sa pagsingil sa WebBrain Compass.",
  ...
  "st.sync.auth.check_email": "Tingnan ang iyong email, aprubahan ang link sa pag-sign in sa WebBrain Compass, pagkatapos ay bumalik dito.",
