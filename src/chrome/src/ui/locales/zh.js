...
export default {
  ...
  "st.system_one.desc_html": "为定时监测和任务完成提供额外验证。",
  "st.system_one.enabled.label": "启用 Jev",
  "st.system_one.api_key.label": "TypeSafe API 密钥",
  "st.system_one.watch.label": "验证定时监测",
  "st.system_one.completion.label": "验证定时任务完成情况",
  "st.system_one.security_html": "向 TypeSafe 发送任务及有限的页面证据。密钥以明文保存在本地，使用可能产生费用。Strict Secret Mode 会禁用 Jev。",
  ...
  'sp.activity.communicating': '正在沟通...',
  'sp.activity.thinking_more': '正在进一步思考...',
  'sp.activity.working_next': '正在处理下一步...',
  'sp.activity.coordinating_next': '正在协调下一步...',
  'sp.activity.checking_next': '正在确认接下来的操作...',
  'sp.activity.preparing_next': '正在准备下一项操作...',
  'sp.activity.connecting_pieces': '正在梳理各项信息...',
  'sp.activity.reviewing_progress': '正在检查进度...',
  'sp.activity.toggle_history': '显示或隐藏活动历史记录',
  ...
  'tool.set_checked': "更新复选框",
  'tool.hover': "悬停",
  'tool.drag_drop': "拖拽元素",
  'tool.press_keys': "按下按键",
  'tool.press_keys.keys': "按下 {keys}",
  'tool.find_text': "查找文本",
  'tool.find_text.text': "查找「{text}」",
  'tool.upload_file': "上传文件",
  'tool.download_files': "下载文件",
  'tool.download_media': "下载媒体",
  'tool.download_resource': '正在下载文件',
  'tool.check_downloads': "查看下载内容",
  'tool.read_downloaded_file': "读取已下载文件",
  'tool.read_frame': "读取框架",
  'tool.get_frames': '正在列出框架',
  'tool.solve_captcha': "正在完成验证",
  'tool.clarify': "请求确认",
  'tool.get_window_info': "检查窗口",
  'tool.resize_window': "调整窗口大小",
  'tool.inspect_viewport': "检查视口",
  'tool.scratchpad_write': "更新便签",
  'tool.progress_update': "更新进度",
  'tool.progress_read': "查看进度",
  'tool.verify_form': "验证表单",
  'tool.chat_observe': "观察聊天",
  'tool.chat_send': "发送消息",
  ...
  "st.vision.local.testing": "正在加载并测试本地视觉模型…",
  ...
  'tr.lineage.standalone': '独立运行',
  'tr.lineage.incomplete': '部分相关运行可能不在已加载的列表中。',
  'tr.lineage.toggle': '展开或折叠子运行',
  'tr.lineage.missing_parent': '父运行不在已加载的列表中。',
  'tr.lineage.ambiguous_parent': '父运行链接不明确；此运行保留为根节点。',
  'tr.lineage.cross_session_parent': '父运行属于其他会话；此运行保留为根节点。',
  'tr.lineage.duplicate_id': '运行 ID 重复；此运行保留为根节点。',
  'tr.lineage.cycle': '检测到循环；此运行保留为根节点。',
  ...
  "st.display.strict_secret.desc": "拒绝在总结或助手文本中引用凭据（密码、API 密钥、令牌、OTP）—— 即使你明确要求也是如此。如果你经常分享轨迹文件或共享屏幕，这会很有用。默认关闭，这样当你需要时，代理可以复述你要求的确切值。当你希望 `done` 总结保持整洁且凭据不被重复显示时，请开启它（设置 → 安全）。",
  ...
  "st.transcription.heading": "语音转文字",
  ...
  'st.display.cloud_bridge.desc': '使用端口 17374 将一个本地控制器连接到此 Chromium 配置文件。一次只能启用一个桥接，并且标准权限提示仍然适用。',
  ...
  "st.display.webmcp.desc": "允许 WebBrain 发现并运行受支持的 Chrome 页面公开的结构化工具。启用后，实验性 WebMCP 工具及其指引会加入模型上下文。默认开启。",
  ...
  "sp.attach.unsupported_type": "{name} 不是支持的附件类型 — 仅支持图像、PDF、JSON、TXT、CSV 和 Markdown 文件。",
  ...
  "st.sync.title": "加密云同步",
  "st.sync.lede_html": "<strong>仅限 WebBrain Compass 会员。</strong>跨设备同步内存、个人资料自动填充和 API 密钥提供商设置。上传之前，所有内容都会使用您的同步密码进行加密。 WebBrain 无法读取或恢复它。聊天历史记录和 OAuth 登录不同步。",
  "st.sync.email.label": "WebBrain Compass 电子邮件",
  ...
  "st.sync.status.subscription": "加密同步需要 WebBrain Compass 会员资格。",
  "st.sync.status.error": "加密同步需要注意。",
  "st.sync.status.auth_required": "使用您的 WebBrain Compass 电子邮件登录以使用加密同步。",
  ...
  "st.sync.validation.email_required": "输入您的 WebBrain Compass 账单电子邮件。",
  ...
  "st.sync.auth.check_email": "检查您的电子邮件，批准 WebBrain Compass 登录链接，然后返回此处。",
