...
export default {
  ...
  'st.display.plan_before_act.desc': 'In Act mode, optionally generate a structured plan before tools run. Off by default. Try mode continues without a pinned plan if planning fails; strict mode cancels instead. Adds one LLM call per Act turn when enabled.',
