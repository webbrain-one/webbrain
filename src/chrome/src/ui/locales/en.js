...
export default {
  ...
  'sp.slash.busy_only_oob': 'Only /help, /show-scratchpad, /list-schedules, /screenshot, /full-page-screenshot, /export, and /verbose can run while WebBrain is busy. Stop the run or try again when it finishes.',
