...
export default {
  ...
  "sp.btn.clear_short": "New chat",
  "sp.btn.history_short": "History",
  ...
  'sp.attach.unsupported_type': '{name} is not a supported attachment type — only images, PDFs, JSON, TXT, CSV, and Markdown files are supported.',
  ...
  "sp.selection_scope.restore": "Use broader conversation",
  ...
  'tool.set_checked': "Updating checkbox",
  'tool.hover': "Hovering",
  'tool.drag_drop': "Dragging element",
  'tool.press_keys': "Pressing keys",
  'tool.press_keys.keys': "Pressing {keys}",
  'tool.find_text': "Finding text",
  'tool.find_text.text': "Finding \"{text}\"",
  'tool.upload_file': "Uploading file",
  'tool.download_files': "Downloading files",
  'tool.download_media': "Downloading media",
  'tool.download_resource': 'Downloading file',
  'tool.check_downloads': "Checking downloads",
  'tool.read_downloaded_file': "Reading downloaded file",
  'tool.read_frame': "Reading frame",
  'tool.get_frames': 'Listing frames',
  'tool.solve_captcha': "Solving verification",
  'tool.clarify': "Asking for clarification",
  'tool.get_window_info': "Checking window",
  'tool.resize_window': "Resizing window",
  'tool.inspect_viewport': "Inspecting viewport",
  'tool.scratchpad_write': "Updating notes",
  'tool.progress_update': "Updating progress",
  'tool.progress_read': "Reading progress",
  'tool.verify_form': "Verifying form",
  'tool.chat_observe': "Observing chat",
  'tool.chat_send': "Sending message",
  'tool.load_skill': "Loading skill",
  'tool.execute_webmcp_tool': "Running WebMCP tool",
  'tool.list_webmcp_tools': 'Listing WebMCP tools',
  'tool.beep': "Playing alert sound",
  ...
  'tool.staged_screenshot': 'Describing screenshot',
  ...
  'st.display.strict_secret.desc': 'Refuse to quote credentials (passwords, API keys, tokens, OTPs) in summaries or assistant text — even when you explicitly ask for them. Useful if you regularly share trace files or screen-share. Off by default so the agent can echo the exact value you ask for when you need it. Turn it on (Settings → Security) when you want `done` summaries kept tidy and credentials never repeated.',
  ...
  'st.display.request_timeout.desc': "Maximum wait for response headers and for each pause between streamed response chunks. Default: 120s. Increase this for slow local models, especially on CPU or with large contexts.",
  ...
  "st.vision.local.testing": "Loading and testing local vision…",
  ...
  'tr.lineage.standalone': 'Standalone run',
  'tr.lineage.incomplete': 'Some related runs may be outside the loaded list.',
  'tr.lineage.toggle': 'Expand or collapse child runs',
  'tr.lineage.missing_parent': 'Parent run is not in the loaded list.',
  'tr.lineage.ambiguous_parent': 'Parent link is ambiguous; this run remains a root.',
  'tr.lineage.cross_session_parent': 'Parent belongs to another session; this run remains a root.',
  'tr.lineage.duplicate_id': 'Duplicate run ID; this run remains a root.',
  'tr.lineage.cycle': 'Cycle detected; this run remains a root.',
  ...
  'st.sync.lede_html': '<strong>WebBrain Compass members only.</strong> Sync memories, profile autofill, and API-key provider settings across devices. Everything is encrypted with your sync password before upload. WebBrain cannot read or recover it. Chat history and OAuth sign-ins are not synced.',
  'st.sync.email.label': 'WebBrain Compass email',
  ...
  'st.sync.status.subscription': 'WebBrain Compass membership is required for encrypted sync.',
  'st.sync.status.error': 'Encrypted sync needs attention.',
  'st.sync.status.auth_required': 'Sign in with your WebBrain Compass email to use encrypted sync.',
  ...
  'st.sync.validation.email_required': 'Enter your WebBrain Compass billing email.',
  ...
  'st.sync.auth.check_email': 'Check your email, approve the WebBrain Compass sign-in link, then return here.',
