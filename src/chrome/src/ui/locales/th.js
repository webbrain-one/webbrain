...
export default {
  ...
  "st.system_one.desc_html": "ตรวจสอบเพิ่มเติมสำหรับการเฝ้าดูและการทำงานตามกำหนดเวลา",
  "st.system_one.enabled.label": "เปิดใช้ Jev",
  "st.system_one.api_key.label": "คีย์ API ของ TypeSafe",
  "st.system_one.watch.label": "ตรวจสอบการเฝ้าดูตามกำหนดเวลา",
  "st.system_one.completion.label": "ตรวจสอบการเสร็จสิ้นของงานตามกำหนดเวลา",
  "st.system_one.security_html": "ส่งงานและหลักฐานจากหน้าเว็บแบบจำกัดไปยัง TypeSafe คีย์จะเก็บในเครื่องเป็นข้อความธรรมดาและอาจมีค่าใช้จ่าย Strict Secret Mode จะปิด Jev",
  ...
  "sp.selection_scope.context_description": "ใช้ข้อความที่เลือก บทสนทนาก่อนหน้าที่ปลอดภัย และความรู้ของโมเดล โดยยังไม่สามารถเข้าถึงหน้า เครื่องมือ ไฟล์ ไฟล์แนบ และเนื้อหาดิบจากหน้าก่อนหน้าได้",
  "sp.selection_scope.restore": "ใช้บทสนทนาทั้งหมด",
  "sp.selection_scope.restore_description": "การคืนค่าจะยกเลิกขอบเขตของข้อความที่เลือก ข้อความถัดไปจะสามารถใช้หน้าปัจจุบัน เครื่องมือเบราว์เซอร์ ไฟล์ ไฟล์แนบ และบทสนทนาก่อนหน้าทั้งหมด รวมถึงบริบทของหน้าได้",
  ...
  'tool.set_checked': "กำลังอัปเดตกล่องกาเครื่องหมาย",
  'tool.hover': "กำลังเลื่อนเมาส์ชี้",
  'tool.drag_drop': "กำลังลากองค์ประกอบ",
  'tool.press_keys': "กำลังกดแป้นพิมพ์",
  'tool.press_keys.keys': "กำลังกด {keys}",
  'tool.find_text': "กำลังค้นหาข้อความ",
  'tool.find_text.text': "กำลังค้นหา \"{text}\"",
  'tool.upload_file': "กำลังอัปโหลดไฟล์",
  'tool.download_files': "กำลังดาวน์โหลดไฟล์",
  'tool.download_media': "กำลังดาวน์โหลดสื่อ",
  'tool.download_resource': 'กำลังดาวน์โหลดไฟล์',
  'tool.check_downloads': "กำลังตรวจสอบการดาวน์โหลด",
  'tool.read_downloaded_file': "กำลังอ่านไฟล์ที่ดาวน์โหลด",
  'tool.read_frame': "กำลังอ่านเฟรม",
  'tool.get_frames': 'กำลังแสดงเฟรม',
  'tool.solve_captcha': "กำลังแก้การยืนยันตัวตน",
  'tool.clarify': "กำลังขอคำชี้แจง",
  'tool.get_window_info': "กำลังตรวจสอบหน้าต่าง",
  'tool.resize_window': "กำลังปรับขนาดหน้าต่าง",
  'tool.inspect_viewport': "กำลังตรวจสอบวิวพอร์ต",
  'tool.scratchpad_write': "กำลังอัปเดตบันทึก",
  'tool.progress_update': "กำลังอัปเดตความคืบหน้า",
  'tool.progress_read': "กำลังอ่านความคืบหน้า",
  'tool.verify_form': "กำลังตรวจสอบแบบฟอร์ม",
  'tool.chat_observe': "กำลังสังเกตการแชท",
  ...
  'tool.staged_screenshot': 'กำลังอธิบายภาพหน้าจอ',
  ...
  "st.display.auto_screenshot.desc": "จับภาพหน้าจอของวิวพอร์ตโดยอัตโนมัติหลังจากเอเจนต์ทำงานบนหน้า เพื่อให้เส้นทางการมองเห็นที่เลือกเห็นการเปลี่ยนแปลง การทำงานนี้ใช้โทเค็นมากขึ้น หากการมองเห็นไม่พร้อมใช้งาน ระบบจะข้ามการเสริมข้อมูลและทำงานต่อพร้อมแจ้งสถานะ",
  ...
  'st.display.lossless_tracing.label': 'บันทึกรายละเอียดคำขอทั้งหมด (ระดับดีบัก)',
  'st.display.lossless_tracing.desc_html': 'จัดเก็บพรอมต์ ข้อความ และโครงสร้างเครื่องมือแบบเต็มของแต่ละคำขอ LLM แทนสรุปที่ไม่มีเนื้อหา และเก็บผลลัพธ์เครื่องมือแต่ละรายการสูงสุด 200 KB เปิดใช้งานการดีบักเชิงลึกและการสร้างคำขอใหม่ ปิดโดยค่าเริ่มต้นเพราะเขียนเนื้อหาสนทนาของคุณในเครื่องและใช้พื้นที่ดิสก์มากกว่ามาก ต้องเปิดการบันทึกเทรซ',
  ...
  'st.display.completion_flash_tab.label': "กะพริบแท็บที่เสร็จแล้ว",
  'st.display.completion_flash_tab.desc': "เมื่องานเสร็จสมบูรณ์ในแท็บที่คุณออกจากไป ชื่อและไอคอนของแท็บนั้นจะกะพริบเพื่อให้เห็นได้ทันทีว่าแท็บใดเสร็จสิ้น",
  ...
  'st.vision.local.title': 'ตัวเลือกสำรอง WebBrain VL 2 450M แบบภายในเครื่อง',
  ...
  "st.vision.local.testing": "กำลังโหลดและทดสอบการมองเห็นในเครื่อง…",
  ...
  'tr.lineage.standalone': 'การทำงานเดี่ยว',
  'tr.lineage.incomplete': 'การทำงานที่เกี่ยวข้องบางรายการอาจอยู่นอกเหนือรายการที่โหลด',
  'tr.lineage.toggle': 'ขยายหรือยุบการทำงานลูก',
  'tr.lineage.missing_parent': 'ไม่พบการทำงานแม่ในรายการที่โหลด',
  'tr.lineage.ambiguous_parent': 'ลิงก์การทำงานแม่ไม่ชัดเจน การทำงานนี้ยังคงเป็นราก',
  'tr.lineage.cross_session_parent': 'การทำงานแม่อยู่คนละเซสชัน การทำงานนี้ยังคงเป็นราก',
  'tr.lineage.duplicate_id': 'รหัสการทำงานซ้ำ การทำงานนี้ยังคงเป็นราก',
  'tr.lineage.cycle': 'ตรวจพบวงจร การทำงานนี้ยังคงเป็นราก',
  ...
  "st.display.strict_secret.desc": "ปฏิเสธการอ้างอิงข้อมูลรับรอง (รหัสผ่าน คีย์ API โทเค็น OTP) ในบทสรุปหรือข้อความของผู้ช่วย — แม้คุณจะขอโดยตรง มีประโยชน์หากคุณแชร์ไฟล์ trace หรือแชร์หน้าจอเป็นประจำ ปิดเป็นค่าเริ่มต้น เพื่อให้เอเจนต์สามารถแสดงค่าที่แน่นอนที่คุณร้องขอออกมาได้เมื่อคุณต้องการ เปิดใช้งาน (การตั้งค่า → ความปลอดภัย) เมื่อคุณต้องการให้บทสรุป `done` เรียบร้อยและไม่มีการอ้างอิงข้อมูลรับรองซ้ำ",
  ...
  "st.transcription.heading": "แปลงเสียงพูดเป็นข้อความ",
  ...
  'st.display.cloud_bridge.desc': 'เชื่อมต่อตัวควบคุมภายในเครื่องหนึ่งตัวกับโปรไฟล์ Chromium นี้โดยใช้พอร์ต 17374 เปิดใช้บริดจ์ได้ครั้งละหนึ่งตัวเท่านั้น และยังคงมีการขอสิทธิ์ตามมาตรฐาน',
  ...
  "st.sync.lede_html": "<strong>สมาชิก WebBrain Compass เท่านั้น</strong> ซิงค์ความทรงจำ การกรอกโปรไฟล์อัตโนมัติ และการตั้งค่าผู้ให้บริการคีย์ API ในอุปกรณ์ต่างๆ ทุกอย่างถูกเข้ารหัสด้วยรหัสผ่านการซิงค์ของคุณก่อนอัปโหลด WebBrain ไม่สามารถอ่านหรือกู้คืนได้ ประวัติการแชทและการลงชื่อเข้าใช้ OAuth จะไม่ซิงค์กัน",
  "st.sync.email.label": "อีเมล WebBrain Compass",
  ...
  "st.sync.status.subscription": "จำเป็นต้องเป็นสมาชิก WebBrain Compass สำหรับการซิงค์ที่เข้ารหัส",
  "st.sync.status.error": "การซิงค์ที่เข้ารหัสต้องได้รับการดูแล",
  "st.sync.status.auth_required": "ลงชื่อเข้าใช้ด้วยอีเมล WebBrain Compass ของคุณเพื่อใช้การซิงค์ที่เข้ารหัส",
  ...
  "st.sync.validation.email_required": "กรอกอีเมลเรียกเก็บเงิน WebBrain Compass ของคุณ",
  ...
  "st.sync.auth.check_email": "ตรวจสอบอีเมลของคุณ อนุมัติลิงก์ลงชื่อเข้าใช้ WebBrain Compass จากนั้นกลับมาที่นี่",
